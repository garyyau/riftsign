...
export function ResultBanner({ children, action }: { children: ReactNode; action?: ReactNode }) {
  return (
    <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 rounded-md border border-border-strong bg-panel px-4 py-3 text-body text-secondary-text">
